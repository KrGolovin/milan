...
enum Token {
	...
	T_UNARY,      // Сводная лексема для "++" и "--"(инкремент и декремент)
...
// Виды унарной операции
enum Unary {
  U_INCREMENT, //операция "++"
  U_DECREMENT //операция "--"
};
...
private:
	...
	Unary unaryValue_; //значение операций инкремента/декремента "++" и "--"
